      ...
      <div className="container mx-auto px-6 z-10 max-w-4xl relative">
        ...
        <div className="animate-fade-in-up flex flex-col items-center" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a href="/docs/Curriculum - Milagros Vairo.pdf" download className="px-8 py-3.5 min-w-[180px] rounded-full bg-gray-900 text-white font-bold hover:bg-brand-pink transition-all duration-300 shadow-md hover:shadow-pink-500/25 active:scale-95 border border-transparent flex items-center justify-center text-sm md:text-base">
              Descargar CV
            </a>
          </div>
        </div>
