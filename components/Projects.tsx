...
const PROJECTS: Project[] = [
  {
    title: "Dashboard de Soporte TI",
    category: "Business Intelligence / Data Analytics",
    type: 'data',
    shortDescription: "Dashboard interactivo en Power BI para el monitoreo integral y análisis de KPIs operativos de un área de soporte tecnológico.",
    fullDescription: "El Dashboard de Soporte TI es una solución analítica interactiva desarrollada en Microsoft Power BI diseñada para ofrecer visibilidad integral sobre el desempeño operativo de un área de soporte tecnológico. La herramienta consolida datos transaccionales del período 2025-2026 y presenta una vista unificada de indicadores clave de rendimiento (KPI) como el volumen de tickets, tiempos de resolución, cumplimiento de Acuerdos de Nivel de Servicio (SLA) y la satisfacción del usuario final.",
    solution: "Arquitectura estructurada bajo un modelo en estrella (Star Schema) optimizada con VertiPaq. Procesamiento ETL para extracción y limpieza mediante Power Query. Centralización de cálculos y métricas mediante funciones DAX, todo presentado en una interfaz con jerarquía visual enfocada en UX.",
    impact: "Transforma datos operativos brutos en información estructurada, permitiendo evaluar la carga de trabajo del equipo, disparar análisis de causa raíz ante desvíos de SLA y detectar qué áreas consumen más horas operativas mediante análisis exploratorio.",
    ...
    gallery: [
      ...
      "/images/dashboard-soporte-IT/gallery-03.png",
      "/images/dashboard-soporte-IT/gallery-04.png",
      "/images/dashboard-soporte-IT/gallery-05.png"
    ]
  },
  {
    title: "Visor Global de Análisis de Utilidad y Márgenes",
    category: "Business Intelligence / Data Analytics",
    type: 'data',
    shortDescription: "Dashboard interactivo en Power BI para el análisis integral del desempeño financiero global, evaluando ingresos, costos y márgenes operativos.",
    fullDescription: "El Visor Global de Análisis de Utilidad y Márgenes es un dashboard interactivo desarrollado en Microsoft Power BI para proporcionar visibilidad integral sobre el desempeño financiero global del negocio. La herramienta consolida datos transaccionales del período 2025-2027, unificando indicadores clave de rendimiento (KPI) relacionados con ingresos, costos, utilidad y márgenes. Durante el período analizado, la organización registró ingresos por 3,36 mil millones y una utilidad neta de 671,11 millones, operando con un margen global del 19,95%.",
    solution: "Arquitectura bajo un enfoque semidesnormalizado optimizada para tiempos de respuesta, procesos ETL en Power Query para limpieza de orígenes estructurados (.xlsx), y métricas explícitas en DAX. Todo esto bajo una interfaz con recorrido visual en patrón F que minimiza la carga cognitiva.",
    impact: "Permitió identificar que América y Asia concentran casi el 75% de la ganancia global, detectar áreas de mejora en países de alto volumen pero bajo margen, y dotar a los usuarios de negocio de capacidades de análisis exploratorio (Self-Service BI).",
    tags: ["Power BI", "Power Query", "DAX", "Data Modeling", "Self-Service BI", "Excel"],
    mainImage: "/images/dashboard-utilidad/gallery-00.png",
    docLink: "/docs/informe_analisis_negocio_2.pdf",
    gallery: [
      "/images/dashboard-utilidad/gallery-01.png",
      "/images/dashboard-utilidad/gallery-02.png",
      "/images/dashboard-utilidad/gallery-03.png"
    ]
  },
  {
    ...
    docLink: "/docs/Informe Final.pdf", // <-- Ruta corregida (sin /public)
    anexosLink: "/docs/Anexos.pdf",
    gallery: [
...
const Projects: React.FC = () => {
  const [filter, setFilter] = useState<'all' | 'dev' | 'design' | 'data'>('all');
  ...
  return (
    <section className="py-24 bg-gray-50" id="projects">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-12 max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 text-lg font-light">
            Explora una selección de mis proyectos en análisis de datos, desarrollo full-stack y diseño UX/UI.
          </p>
        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 lg:divide-x divide-gray-100">
                ...
                <div className="col-span-2 p-8 md:p-12 space-y-8">
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${selectedProject.type === 'design' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700'
                        }`}>
                ...
                <div className="p-8 md:p-12 bg-gray-50 space-y-8 h-full">
                  ...
                  <div className="space-y-4">
                    ...
                    {selectedProject.docLink && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex items-center justify-center w-full py-3 bg-brand-pink/10 border-2 border-brand-pink text-brand-pink rounded-xl font-semibold hover:bg-brand-pink hover:text-white transition-colors gap-2"
                      >
                        <Download size={18} /> Ver Documentación
                      </a>
                    )}
                    {selectedProject.anexosLink && (
                      <a
                        href={selectedProject.anexosLink}
                        target="_blank"
                        rel="noreferrer"
                        className="flex items-center justify-center w-full py-3 bg-brand-pink/10 border-2 border-brand-pink text-brand-pink rounded-xl font-semibold hover:bg-brand-pink hover:text-white transition-colors gap-2"
                      >
                        <Download size={18} /> Ver Anexos
                      </a>
                    )}
                  </div>
                  {/* Technologies */}
                  ...
                  <div className="pt-8 border-t border-gray-200">
                    <p className="text-gray-500 text-sm mb-4">¿Te gustaría implementar una solución similar?</p>
      ...
      {selectedProject && lightboxImage !== null && (() => {
        const fullGallery = getFullGallery(selectedProject);
        return (
          <div className={`fixed inset-0 z-[60] bg-black/90 backdrop-blur-sm ${isZoomed ? 'overflow-auto' : 'flex items-center justify-center'
            } px-4 py-6`}>
            <button
              onClick={() => {
                setLightboxImage(null);
